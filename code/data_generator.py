...
def train_generate(datapath, batch_size, few, symbol2id, ent2id, e1rel_e2):
	...
	while True:
		...
		support_origin_pairs = [[triple[0], triple[2]] for triple in support_triples]
		...
		yield support_origin_pairs, support_pairs, query_pairs, false_pairs, support_left, support_right, query_left, query_right, false_left, false_right
